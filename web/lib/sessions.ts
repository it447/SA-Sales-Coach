...
// sessionTitle/scopeCompletionPercent/sessionDurationLabel moved to
// sessionDisplay.ts (pure, no `pool`/pg import) so a client component can
// import them without pulling this file's DB code into the client bundle.
// Re-exported here so nothing that already imports them from this file
// (e.g. dashboard/[id]/page.tsx) needs to change.
export { sessionTitle, scopeCompletionPercent, sessionDurationLabel } from "./sessionDisplay";
